...
var distanciaAceptableColor = 140;

var sensibilidadGiro = 1;
...
function procesarCamara() {
    ...
    if (masGrande != null) {
        ...
        document.getElementById("info").innerHTML = "Grados: " + masGrande.grados;
        var nuevosGrados = - masGrande.grados * sensibilidadGiro;
        document.getElementById("carrito")
        .style.transform="rotate(" + nuevosGrados + "deg)";

        var ancho = masGrande.xMaxima - masGrande.xMinima;

        // ! Modificar esto para enviar nuevos datos
...
function enviarMovimiento(grados, yMinima, ancho) {
    ...
    var movimiento = "0"; //0: no mueve, 1: gira a la izquierda, 2: gira a la derecha
    ...
    }//0: no brinco, 1: brinco

    var acelerar = "0"; //0: no acelera, 1: acelera
